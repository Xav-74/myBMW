		...
		success: function (data) { 			
			...
			if (data.state != 'ok') {
				...
				if ( $('.eqLogicAttr[data-l2key=vehicle_brand]').value() == 2 )	{
					...
					$('#div_type').append('<input id="type" type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="vehicle_type" placeholder="Type de véhicule" value="Non communiqué" readonly>');
